...
def fruit_ninja():
    ...
    pygame.init()
    pygame.display.set_caption('Fruit-Ninja Game -- Madugula Jayaram')
    ...
    background = pygame.image.load('img/back.jpg')                                  #game background
    font = pygame.font.Font('font/comic.ttf', 42)
    score_text = font.render('Score : ' + str(score), True, (255, 255, 255))    #score display
    lives_icon = pygame.image.load('img/white_lives.png')                    #images that shows remaining lives
    ...
    def hide_cross_lives(x, y):
        gameDisplay.blit(pygame.image.load("img/red_lives.png"), (x, y))

    # Generic method to draw fonts on the screen
    font_name = pygame.font.match_font('font/comic.ttf')
    ...
    while game_running :
        if game_over :
            ...
            game_over = False
            player_lives = 3
            draw_lives(gameDisplay, 690, 5, player_lives, 'img/red_lives.png')
            score = 0
            ...
            if value['throw']:
                ...
                if not value['hit'] and current_position[0] > value['x'] and current_position[0] < value['x']+60 \
                    ...
                    if key == 'bomb':
                        ...
                        half_fruit_path = "img/explosion.png"
                    else:
                        half_fruit_path = "img/half_" + key + ".png"
