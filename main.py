...
import sys
from tracemalloc import start # We will use sys.exit to exit the program
import pygame
import time
from pygame.locals import * # Basic pygame imports

def welcomeScreen():
        global FPS,FPSCLOCK , SCREENWIDTH, SCREENHEIGHT, SCREEN, GROUNDY, GAME_SPRITES, GAME_SOUNDS, PLAYER, BACKGROUND, PIPE
...
def isCollide(playerx, playery, upperPipes, lowerPipes):
        ...
        for pipe in lowerPipes:
            if (playery + GAME_SPRITES['player'].get_height() > pipe['y']-2) and abs(playerx - pipe['x']) < GAME_SPRITES['pipe'][0].get_width()-18:
                GAME_SOUNDS['hit'].play()
                return True
